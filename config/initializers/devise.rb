...
Devise.setup do |config|
  ...
  # config.secret_key = '5b65b0a4bfcbd802500b0ccbd1e3ed8c9c8c7889b6a46b1
  #                      e56bc01195b5c157b5fe3cce37a3235d99f9ec0021309f5
  #                      b22e750b69f5445699b4bd42d5bbc2b167'
  ...
  # lookup.
  # For instance, if you set :request_keys to [:subdomain], :subdomain
  ...
  # stretches
  # (e.g. a value of 20 is already extremely slow  approx. 60 seconds for
  # 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper =
  #   'dd75d6ed3fe96f7e848dbef3f070198207823d538a37eda94f123f49744b5f7cdb30a3'
  ...
  # their password is reset. Defaults to true, so a user is signed
  # in automatically after a reset.
  ...
  # to 20 for default behavior) and :restful_authentication_sha1
